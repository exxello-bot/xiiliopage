      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <ul className="space-y-2 font-body text-sm text-muted-foreground">
            ...
            <li><span className="text-foreground">Shawn Motunmori</span> — <span className="bg-gradient-to-r from-blue-400 via-slate-400 to-blue-500 bg-clip-text text-transparent">Asia Team.</span></li>
          </ul>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto mt-12 pt-8 border-t border-border">
        <div className="flex flex-wrap justify-center gap-4 mb-8">
          <a
            ...
            className="group inline-flex items-center gap-3 px-6 py-3.5 rounded-xl border border-white/10 transition-all duration-300 hover:scale-105 hover:shadow-[0_8px_30px_rgba(52,168,83,0.3)]"
            style={{
              background: 'linear-gradient(145deg, #2d2d2d 0%, #1a1a1a 50%, #0d0d0d 100%)',
              boxShadow: '0 4px 15px rgba(0,0,0,0.4), inset 0 1px 0 rgba(255,255,255,0.1), inset 0 -1px 0 rgba(0,0,0,0.3)',
            }}
          >
            ...
            <div className="text-left">
              <div className="text-[10px] uppercase leading-none text-white/60 tracking-wider">Get it on</div>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group inline-flex items-center gap-3 px-6 py-3.5 rounded-xl border border-white/10 transition-all duration-300 hover:scale-105 hover:shadow-[0_8px_30px_rgba(255,255,255,0.15)]"
            style={{
              background: 'linear-gradient(145deg, #2d2d2d 0%, #1a1a1a 50%, #0d0d0d 100%)',
              boxShadow: '0 4px 15px rgba(0,0,0,0.4), inset 0 1px 0 rgba(255,255,255,0.1), inset 0 -1px 0 rgba(0,0,0,0.3)',
            }}
          >
            ...
            <div className="text-left">
              <div className="text-[10px] uppercase leading-none text-white/60 tracking-wider">Download on the</div>
